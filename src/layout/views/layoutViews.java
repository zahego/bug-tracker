...
public class layoutViews extends JFrame {
	...
	private void initComponents() {
		...
		JScrollPane scrollOngoing = new JScrollPane();
		...
		gl_OnGoingPanel.setHorizontalGroup(
			gl_OnGoingPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_OnGoingPanel.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_OnGoingPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_OnGoingPanel.createSequentialGroup()
							.addComponent(OnGoingLabel)
							.addGap(37))
						.addGroup(gl_OnGoingPanel.createSequentialGroup()
							.addComponent(scrollOngoing, GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
							.addContainerGap())))
		);
		gl_OnGoingPanel.setVerticalGroup(
			gl_OnGoingPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_OnGoingPanel.createSequentialGroup()
					...
					.addComponent(OnGoingLabel)
					.addGap(8)
					.addComponent(scrollOngoing, GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		gl_OnTakenPanel.setHorizontalGroup(
			gl_OnTakenPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_OnTakenPanel.createSequentialGroup()
					.addGroup(gl_OnTakenPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_OnTakenPanel.createSequentialGroup()
							.addGap(37)
							.addComponent(OnTakenLabel))
						.addGroup(gl_OnTakenPanel.createSequentialGroup()
							.addContainerGap()
							.addComponent(scrollTaken, GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)))
					.addContainerGap())
		);
		gl_OnTakenPanel.setVerticalGroup(
			gl_OnTakenPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_OnTakenPanel.createSequentialGroup()
					...
					.addComponent(OnTakenLabel)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(scrollTaken, GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		gl_LeftProjectPanel.setHorizontalGroup(
			gl_LeftProjectPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_LeftProjectPanel.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(FilterButtonL, GroupLayout.PREFERRED_SIZE, 33, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(MinimizeButtonL, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addGroup(gl_LeftProjectPanel.createSequentialGroup()
					.addGap(10)
					.addComponent(scrollBacklog, GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
					.addGap(10))
		);
		gl_LeftProjectPanel.setVerticalGroup(
			gl_LeftProjectPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_LeftProjectPanel.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(scrollBacklog, GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
					.addContainerGap())
		);
		LeftProjectPanel.setLayout(gl_LeftProjectPanel);
		
		JScrollPane scrollFinish = new JScrollPane();
		...
		gl_RightProjectPanel.setHorizontalGroup(
			gl_RightProjectPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_RightProjectPanel.createSequentialGroup()
					.addGap(25)
					.addComponent(SortButtonR, GroupLayout.PREFERRED_SIZE, 33, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(FilterButtonR, GroupLayout.PREFERRED_SIZE, 34, Short.MAX_VALUE)
					.addGap(10)
					.addComponent(MinimizeButtonR))
				.addGroup(gl_RightProjectPanel.createSequentialGroup()
					.addContainerGap()
					.addComponent(scrollFinish, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
					.addGap(10))
		);
		gl_RightProjectPanel.setVerticalGroup(
			gl_RightProjectPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_RightProjectPanel.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(scrollFinish, GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
					.addContainerGap())
		);
